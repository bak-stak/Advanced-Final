...
```{r}
#| echo: false
#| label: tab-plain-merged
#| tab-cap: "Results for logistic regression of institutional distrust on populist vote and abstension" 
...
#| label: Tab-cdt 
#| echo: false 
#| tab-label: "Logistic regression on observations <8"
...
#| label: fig-cdt
#| echo: false
#| fig-label: "CDT logistic regression model"
...
Age classes were then added to the model both through additive and interactions models. The different specifications aim is to compute: (1) for additive model the specific mere effect of age class on populist voting and abstention, (2) for interaction models how each age class act as a moderator for the effect that institutional distrust has on the two dependent variables.

<!-- final regression table: 1. pop-add 2. abs-add 3. pop-int 4. abs-int 5. cdt-add 6. cdt-int -->

```{r}
#| label: Models performing
#| include: false
```
